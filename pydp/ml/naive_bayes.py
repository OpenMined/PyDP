...
class GaussianNB(sk_nb.GaussianNB):
    ...
    def __init__(self, epsilon=1.0, probability=1e-2,bounds=None, priors=None, var_smoothing=1e-9, accountant=None):
    ...
    def _noisy_class_counts(self, y):
        ...
        mech = GeometricTruncated().set_epsilon(self.epsilon / 3).set_sensitivity(1).set_bounds(1, n_total).set_probability(self.probability)
