...
m.def("test_StatusCode", [](differential_privacy::base::StatusCode z) {

    string prepend = "differential_privacy::base::StatusCode::";
    switch(z) {
        case differential_privacy::base::StatusCode::kOk:
            return (prepend + "kOk").c_str();
            break;
        default:
            return "kUnknown";
            break;
